...
This can be seen if we hide the back side of the triangles:
...
We can use it to change the facet orientation:
...
See a four-dimensional example in [the vignette](https://cran.r-project.org/web/packages/cxhull/vignettes/truncated_tesseract.html). 
