...
The output of the `cxhull` function is a list with the following fields.
  ...
  - `edges`: The edges of the convex hull, given as pairs of verticies
    identifiants.
...
non-missing value only when one requires the triangulation of the convex
hull:
...
## + 4/4 vertices, named, from 3159bf4:
## [1] 6 8 4 2
```
